...
with prep as (
    ...
    from
        {{ ref('snowplow_batch_engine_events') }}
)
...
select
        ...
        array(struct(
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].transaction_id AS transaction_id,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].currency AS currency,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].payment_method AS payment_method,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].revenue AS revenue,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].total_quantity AS total_quantity,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].credit_order AS credit_order,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].discount_amount AS discount_amount,
            contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].discount_code AS discount_code,
        ...
        )) AS contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1
    from
        prep
