...
#}
  ...
  , flatten as (
    select
      *,
      contexts_nl_basjes_yauaa_context_1[0].agentClass as agentClass,
      contexts_nl_basjes_yauaa_context_1[0].agentInformationEmail as agentInformationEmail,
      contexts_nl_basjes_yauaa_context_1[0].agentName as agentName,
      contexts_nl_basjes_yauaa_context_1[0].agentNameVersion as agentNameVersion,
      contexts_nl_basjes_yauaa_context_1[0].agentNameVersionMajor as agentNameVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].agentVersion as agentVersion,
      contexts_nl_basjes_yauaa_context_1[0].agentVersionMajor as agentVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].deviceBrand as deviceBrand,
      contexts_nl_basjes_yauaa_context_1[0].deviceClass as deviceClass,
      contexts_nl_basjes_yauaa_context_1[0].deviceCpu as deviceCpu,
      contexts_nl_basjes_yauaa_context_1[0].deviceCpuBits as deviceCpuBits,
      contexts_nl_basjes_yauaa_context_1[0].deviceName as deviceName,
      contexts_nl_basjes_yauaa_context_1[0].deviceVersion as deviceVersion,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineClass as layoutEngineClass,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineName as layoutEngineName,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineNameVersion as layoutEngineNameVersion,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineNameVersionMajor as layoutEngineNameVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineVersion as layoutEngineVersion,
      contexts_nl_basjes_yauaa_context_1[0].layoutEngineVersionMajor as layoutEngineVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].networkType as networkType2,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemClass as operatingSystemClass,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemName as operatingSystemName,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemNameVersion as operatingSystemNameVersion,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemNameVersionMajor as operatingSystemNameVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemVersion as operatingSystemVersion,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemVersionBuild as operatingSystemVersionBuild,
      contexts_nl_basjes_yauaa_context_1[0].operatingSystemVersionMajor as operatingSystemVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].webviewAppName as webviewAppName,
      contexts_nl_basjes_yauaa_context_1[0].webviewAppNameVersionMajor as webviewAppNameVersionMajor,
      contexts_nl_basjes_yauaa_context_1[0].webviewAppVersion as webviewAppVersion,
      contexts_nl_basjes_yauaa_context_1[0].webviewAppVersionMajor as webviewAppVersionMajor,
      ...
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].transaction_id as transactionId,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].currency as currency,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].payment_method as paymentMethod,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].revenue as revenue,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].total_quantity as totalQuantity,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].credit_order as creditOrder,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].discount_amount as discountAmount,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].discount_code as discountCode,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].shipping as shipping,
      contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1[0].tax as tax
    from prep
  ...
  select
    ...
    to_variant(ARRAY_CONSTRUCT(OBJECT_CONSTRUCT_KEEP_NULL('transactionId',transactionId,'currency',currency,'paymentMethod',paymentMethod,'revenue',revenue,'totalQuantity',totalQuantity,'creditOrder',creditOrder,'discountAmount',discountAmount,'discountCode',discountCode,'shipping',shipping,'tax',tax))) as contexts_com_snowplowanalytics_snowplow_ecommerce_transaction_1
  from flatten
