...
#   timestamp: 2025-05-23T14:22:20+00:00
...
class EntityIdentifiers(BaseModel):
    domain_userid: Optional[List] = Field(None, title="Domain Userid")
    domain_sessionid: Optional[List] = Field(None, title="Domain Sessionid")
    network_userid: Optional[List] = Field(None, title="Network Userid")
    user_id: Optional[List] = Field(None, title="User Id")
