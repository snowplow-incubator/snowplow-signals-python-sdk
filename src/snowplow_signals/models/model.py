...
#   timestamp: 2026-05-21T12:08:28+00:00
...
class BatchSyncStatusResponse(BaseModel):
    status: Literal["running", "completed"] = Field(
        ...,
        description="'completed' when every expected sync interval for every attribute in the group has status 'completed' in sync_log. 'running' when any interval is still pending or running, or when the batch engine has not been deployed yet.",
        title="Status",
    )
