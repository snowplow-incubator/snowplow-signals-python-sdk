...
#   timestamp: 2025-03-21T13:13:15+00:00
...
class CriterionInput(BaseModel):
    ...
    value: Union[str, int, float, bool] = Field(
        ..., description='The value to compare the property to.', title='Value'
    )
...
class Entity(BaseModel):
    ...
    ttl: Optional[timedelta] = Field(
        None,
        description='The amount of time that attributes for the entity will live in the online store.',
        title='Ttl',
    )
...
class ViewInput(BaseModel):
    ...
    ttl: Optional[timedelta] = Field(
        None,
        description="The amount of time this group of attributes lives. If not specified, the entity's ttl is used.",
        title='Ttl',
    )
